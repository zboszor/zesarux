...
*/
  if (MACHINE_IS_SPECTRUM_128_P2_P2A_P3 || MACHINE_IS_ZXUNO || MACHINE_IS_CHLOE || MACHINE_IS_PRISM || MACHINE_IS_TBBLUE || MACHINE_IS_PENTAGON || MACHINE_IS_CHROME || MACHINE_IS_EVO) {
/*
-Block ID 5: ZSF_SPEC128_MEMCONF
Byte Fields:
0: Port 32765 contents
